...
dayOfTheWeek.numDays = function(month, year){
  return (month === 2 && this.isLeap(year)) ? 29 : days_in_month[month];
}

dayOfTheWeek.isLeap = function(year) {
  if (year % 4 === 0 && (year % 100 !== 0 || year % 400 === 0)) {return true;}
  return false;
}

dayOfTheWeek.writeMonth = function(month, year){
  j = 1;
...
dayOfTheWeek.makeHeader = function() {
  var line = "";
  var spaces = "";
...
dayOfTheWeek.makeFirstLine = function() {
  var line = "";
...
dayOfTheWeek.makeOtherLine = function() {
  var line = "";
  for (var i = 0; i <= 6; i++) {
